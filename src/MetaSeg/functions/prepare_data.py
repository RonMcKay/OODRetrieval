...
"""
This script was tested for the cityscapes and ds20k dataset.
...
Note, that this script assumes the softmax outputs to be available as numpy files
(*.npy) per image. Moreover, pay attention to the filenames as this script assumes
an unique (sub-)string for every image and its corresponding ground_truth as well
as probabilties array.
"""
